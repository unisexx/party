...
class LawController extends Controller
{
	...
	public function getIndex()
	{
		...
		return view('fdadmin.law.index', $data);
	}
	...
	public function getForm($id = null)
	{
		...
		$data['rs'] = Law::find($id);
		return view('fdadmin.law.form', $data);
	}
	...
	public function postSave(Request $rq, $id = null)
	{
		...
		return Redirect('fdadmin/law/index');
	...
	{
		$data['rs'] = Law::find($id);
		return view('fdadmin.law.view', $data);
	}
